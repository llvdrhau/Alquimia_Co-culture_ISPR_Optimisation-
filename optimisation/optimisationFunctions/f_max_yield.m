function [costFunc,productivity,parameters,t,y,reservoir] = f_max_yield(decisionVar,parameters,xInitial)
...
%    This script calculates the max yield of proprionate as an
%    objective variable
...
costFunc = yieldActual;
%costFunc  = max(yieldActual,-0.7);  % so simulation doesn't stretch out 
%decisionVar
