function [costFunc,yield,parameters,t,y] = f_max_productivity2(decisionVar,parameters,xInitial)
...
%    This script calculates the max productivity of proprionate as an
%    objective variable
...
yield = propMade/gluAdded; % only considering proprionate that makes it to
%the reservoir 
...
%     decisionVar
% else
%     costFunc = -reservoir(end,pos_pro)/t(end) + 1e10
%     decisionVar
% end
