function [c,ceq] = productivityConstraint(decisionVar,parameters,xInitial)
...
%    This script calculates productivity  of proprionate as a constraint 
...
productivity = reservoir(end,pos_pro)/t(end);   %in gCOD/L/h


c = 0.58 - productivity; %  0,6 was succes 
ceq = 0 ;
