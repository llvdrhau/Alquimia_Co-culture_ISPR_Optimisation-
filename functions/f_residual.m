...
%% This function calculates the residuals for parameter estimation
...
for i = 1:length(names)
    ...
    switch caso
        case 'normal'  % is to normalise the residual
...
if strcmp(solver,'fconmin')  % incase fmin con is to be used 
